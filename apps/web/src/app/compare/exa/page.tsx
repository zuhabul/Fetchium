...
const rows = [
  ...
  { feature: "MCP protocol support", f: "yes", e: "partial", note: "Exa has MCP; Fetchium has 5 tools including research and extract" },
  { feature: "Self-hostable", f: "yes", e: "no", note: "Fetchium runs on any Docker host; Exa is cloud-only" },
