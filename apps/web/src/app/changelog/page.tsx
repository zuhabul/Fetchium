...
const entries = [
  {
    ...
    changes: [
      ...
      { type: "new", text: "11+ search backends: DuckDuckGo, Brave, Bing, GitHub, Reddit, HackerNews, StackOverflow, YouTube, ArXiv, Wikipedia, SearXNG" },
      { type: "new", text: "REST API: /v1/search, /v1/scrape, /v1/research, /v1/youtube, /v1/social" },
      { type: "new", text: "MCP server with 5 tools (search, extract, research, youtube, social)" },
      { type: "new", text: "CLI: 26 commands including search, compare, doctor, provider, export" },
      { type: "new", text: "LangChain and CrewAI adapters" },
      ...
      { type: "new", text: "563+ tests, zero warnings, zero clippy lints" },
    ],
  },
];
