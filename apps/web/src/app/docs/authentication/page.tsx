...
export default function Authentication() {
  return (
    <article className="docs-content max-w-3xl">
      ...
      <CodeBlock language="bash" code={`curl -X POST https://api.fetchium.com/v1/search \\
  ...
  -d '{"name": "CI Pipeline", "scopes": ["search"]}'`} />
      ...
      <h3>Revoke a key</h3>
      <CodeBlock language="bash" code={`curl -X DELETE https://api.fetchium.com/v1/keys/key_abc123 \\
  -H "Authorization: Bearer fetchium_your_key"`} />
