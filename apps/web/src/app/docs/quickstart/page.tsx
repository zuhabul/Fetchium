  ...
  -d '{
    ...
    "citation_style": "apa"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose">
        {[
          { href: "/docs/api/search", title: "Search API Reference", desc: "Full parameter docs" },
          { href: "/docs/api/research", title: "Research API Reference", desc: "Deep research pipeline" },
          { href: "/docs/authentication", title: "Authentication", desc: "Key management, rotation" },
