...
export default function ScrapeApiReference() {
  return (
    <article className="docs-content max-w-3xl">
      ...
      <CodeBlock language="bash" filename="scrape.sh" code={`curl -X POST https://api.fetchium.com/v1/scrape \\
  ...
  "segments": [
    ...
    },
    {
      ...
      <CodeBlock language="bash" code={`curl -X POST https://api.fetchium.com/v1/scrape \\
  -H "Authorization: Bearer fetchium_your_key" \\
  -H "Content-Type: application/json" \\
