...
export default function AsyncJobsApiReference() {
  return (
    <article className="docs-content max-w-3xl">
      ...
      <h2>Submit a job</h2>
      <CodeBlock language="bash" filename="submit-research-job.sh" code={`curl -X POST ***REMOVED***/v1/research/jobs \\
  ...
  "status_url": "/v1/jobs/f6ca2d8d-4b7c-4b26-8187-676121c1a8c1"
      ...
      <CodeBlock language="bash" filename="poll-job.sh" code={`curl ***REMOVED***/v1/jobs/f6ca2d8d-4b7c-4b26-8187-676121c1a8c1 \\
  -H "Authorization: Bearer $FETCHIUM_API_KEY"`} />
