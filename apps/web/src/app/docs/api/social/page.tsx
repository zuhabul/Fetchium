...
export default function SocialApiReference() {
  return (
    <article className="docs-content max-w-3xl">
      ...
      <CodeBlock language="bash" filename="social.sh" code={`curl -X POST https://api.fetchium.com/v1/social \\
  ...
  -d '{
    ...
    "include_comments": true
      ...
      <CodeBlock language="typescript" filename="social.ts" code={`const res = await fetch("https://api.fetchium.com/v1/social", {
  method: "POST",
  headers: {
