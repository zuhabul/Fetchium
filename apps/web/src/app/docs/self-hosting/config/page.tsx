...
`} />
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>SEARXNG_URL</code></td><td><code>search.searxng_url</code></td><td><code>***REMOVED***</code></td></tr>
          ...
          <tr><td><code>***REMOVED***</code></td><td>Admin authentication key</td><td>(32+ char secret)</td></tr>
        </tbody>
      </table>
...
# Set a value
fetchium config set search.searxng_url ***REMOVED***
...
SEARXNG_URL=***REMOVED*** fetchium search "rust async"
