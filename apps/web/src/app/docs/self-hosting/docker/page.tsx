...
# Edit infra/fetchium.env.production.local to set ***REMOVED*** and other settings
...
volumes:
  fetchium-data:`} />
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>***REMOVED***</code></td><td>Yes</td><td>Admin API secret (min 32 chars). Generate: <code>openssl rand -hex 32</code></td></tr>
