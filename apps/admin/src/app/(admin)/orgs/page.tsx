          ...
          {orgs.length === 0 && !error ? (
            ...
            <>
              <div className="lg:hidden divide-y divide-zinc-800/50">
                {orgs.map(org => (
                  <div key={org.id} className="space-y-4 px-4 py-4">
                    ...
                    <dl className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        <dt className="text-[11px] uppercase tracking-wider text-zinc-600">MRR</dt>
                        <dd className="mt-1 text-zinc-300">
                          {org.mrr_cents ? `$${(org.mrr_cents / 100).toFixed(2)}` : '—'}
                        </dd>
                      </div>
                      <div>
                        <dt className="text-[11px] uppercase tracking-wider text-zinc-600">Members</dt>
                        <dd className="mt-1 text-zinc-300">{org.member_count ?? '—'}</dd>
                      </div>
