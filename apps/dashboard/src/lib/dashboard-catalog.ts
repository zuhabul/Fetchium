...
export const dashboardEndpoints: DashboardEndpoint[] = [
  ...
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/fetch \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${fetchBody}'`,
    playgroundSupported: true,
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/estimate \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${estimateBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleBody: researchBody,
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/research/jobs \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${researchBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/youtube/search \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${youtubeSearchBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleBody: youtubeSearchBody,
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/youtube/search/jobs \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${youtubeSearchBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/youtube/analyze \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
  ...
  },
  {
    ...
    sampleBody: youtubeAnalyzeBody,
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/youtube/analyze/jobs \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${youtubeAnalyzeBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/social/research \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
  ...
  },
  {
    ...
    sampleBody: socialResearchBody,
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/social/research/jobs \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${socialResearchBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/social/reddit \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${redditBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleBody: redditBody,
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/social/reddit/jobs \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${redditBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/social/hackernews \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${hackerNewsBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    sampleBody: hackerNewsBody,
    sampleCurl:
      `curl -X POST https://api.fetchium.com/v1/social/hackernews/jobs \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY" \\\n` +
      `  -H "Content-Type: application/json" \\\n` +
      `  -d '${hackerNewsBody}'`,
    playgroundSupported: true,
  ...
  },
  {
    ...
    docsHref: "https://docs.fetchium.com/api/async-jobs",
    sampleCurl:
      `curl https://api.fetchium.com/v1/jobs/JOB_ID \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY"`,
    playgroundSupported: true,
    pollingRoute: "/v1/jobs/:id",
    requiresPathParam: "id",
  ...
  },
  {
    ...
    sampleCurl:
      `curl https://api.fetchium.com/v1/usage \\\n` +
      `  -H "Authorization: Bearer fetchium_YOUR_KEY"`,
  },
];
