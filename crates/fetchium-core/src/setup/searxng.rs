...
//!
//! Powers `fetchium setup --searxng` — generates an optimised `settings.yml`,
...
/// Return the current status of the fetchium-searxng container.
...
# Generated by `fetchium setup --searxng` — edit freely
